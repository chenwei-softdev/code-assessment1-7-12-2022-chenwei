        ...
        <React.Fragment>
            <div className='landing-header-bg-img' >
                <ul className='landing-ul'>
                    ...
                    {
                        barState == '' ?
                            <div className='float-right landing-li navbar' style={{ 'display': 'block' }}>
                    ...
                    <div>
                        <div className='landing-search' style={{ 'display': 'flex' }}>
                            ...
                            <div className='landing-search-item'>
                                ...
                                <div className=''>
                                    <select className='select'>
                                        <option>Select your dates</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
                                </div>
                            ...
                            <div className='landing-search-item'>
                                ...
                                <div className=''>
                                    <select className='select'>
                                        <option>Select your guests</option>
                                        <option>1</option>
                                        <option>2</option>
                                    </select>
                                </div>
                            </div>
                            <div className='landing-search-item landing-search-btn cursor-point'>
                ...
                <h1 className='bars index-99' onClick={bars}><i className='fa fa-bars'></i></h1>
